...
% 오늘은 편의상 아래와 같이 나누겠음
% 1~50: setosa: versicolor, 101~150: virginica
% 학습데이터. 71~100: versicolor, 121~150: virginica 총 60개
% 평가데이터. 51~70: versicolor, 101~120: virginica 총40개
...
%% 매트랩 내부 함수를 이용한 KNN 모델 만들기 (학습: 결정해 할 : k, 거리를 어떤 방법으로 할지)
k = 3; % 인접한 이웃 3개를 보겠다.
mdl = fitcknn(Training_data, Training_label, 'NumNeightbors', k, 'distance', 'euclidean');
